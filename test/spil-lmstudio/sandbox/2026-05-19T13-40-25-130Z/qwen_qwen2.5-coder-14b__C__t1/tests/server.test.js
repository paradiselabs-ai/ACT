...
describe('Server', () => {
  ...
  it('should return an empty array for GET /users initially', async () => {
  ...
  it('should return 400 for POST /users with missing email', async () => {
    const response = await request(app)
      .post('/users')
      .send({ name: 'John Doe' });
  ...
  it('should return 404 for GET /users/:id with unknown id', async () => {
